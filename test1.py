...
class DSTSMGSER:
    ...
    def build_model(self):
        ...
        # Replace SpatioTemporalSummaryMixingLayer with LinearSummaryAttentionLayer
        summary_attention_layer = LinearSummaryAttentionLayer(d_model=128, use_weighted_summary=self.use_weighted_summary)
        x = Lambda(lambda x: tf.expand_dims(x, axis=1))(x)  # Expand dimensions for attention mechanism
...
# with Linear Summary Attention Mechanism
# python test1.py
